...
interface BestServicesListingProps {
  services: DevelopedServiceData[];
}

export default function BestServicesListing({
  services,
}: BestServicesListingProps) {
  ...
  const ui =
    locale === "bn"
      ? {
          ...
          title: "সেরা সেবাসমূহ",
          subtitle:
            "রোগীদের আস্থা ও মানসম্মত ফলাফলের ভিত্তিতে নির্বাচিত আমাদের সেরা ডেন্টাল সেবাগুলো দেখুন।",
          duration: "সময়কাল",
      ...
      : {
          ...
          title: "Best Services",
          subtitle:
            "Explore our best-performing dental services chosen for trusted outcomes and patient satisfaction.",
          duration: "Duration",
            ...
            return (
              <Card key={service.slug} hover className="h-full flex flex-col">
                <CardBody className="flex h-full flex-col">
                  ...
                  <Link
                    href={`/best-services/${service.slug}`}
                    className="mt-auto"
                  >

...
interface BestServiceDetailProps {
  service: DevelopedServiceData;
  relatedServices: DevelopedServiceData[];
}

export default function BestServiceDetail({
  service,
  relatedServices,
}: BestServiceDetailProps) {
  ...
  const ui =
    locale === "bn"
      ? {
          ...
          benefits: "উপকারিতা",
          step: "ধাপ",
          related: "সম্পর্কিত সেরা সেবা",
          viewAll: "সব সেরা সেবা দেখুন",
      ...
      : {
          ...
          benefits: "Benefits",
          step: "Step",
          related: "Related Best Services",
          viewAll: "View all best services",
  ...
  return (
    <div className="bg-slate-50 min-h-screen">
      <section className="bg-linear-to-br from-emerald-700 via-teal-600 to-cyan-500 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 lg:py-16">
          <nav
            aria-label="Breadcrumb"
            className="text-sm text-emerald-100 mb-6"
          >
            <ol className="flex items-center gap-2">
              ...
              <li>/</li>
              <li>
                <Link href="/best-services" className="hover:text-white">
                  {ui.best}
                </Link>
              </li>
              <li>/</li>
              ...
              return (
                <Card key={related.slug} hover>
                  <CardBody>
                    ...
                    <Link
                      href={`/best-services/${related.slug}`}
                      className="inline-block mt-2 text-xs text-emerald-700 hover:underline"
                    >
                      {ui.readDetails}
                    </Link>
                  </CardBody>
